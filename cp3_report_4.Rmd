...
Ethnic, religion, languages, primary language, literacy, education, gender, age, 
...
We asked respondents about their listening to: (1) Douniarou Derkeen, (2) Dabalate, (3) Chabab-al-Haye, and (4) Dandal Kura.  Only nine people listened to Dabalaye; only three people listened to Chabab, and zero people listened to Dandal_Kura.  As a result, here we show only the viewership of Douniarou Derkeen, which 296 respondents listened to (about 30% of the entire sample, and `r round(296/(296+440),2)*100`\% of radio listeners).
