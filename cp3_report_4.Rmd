...
Overall, perceptions of youth respect for elders is very high.  Overall respondents score `r round(mean(cpdf$form.Attitudes.old_people_get_it,na.rm=T),2)` on a 0-1 scale when asked if old people understand young people, and score `r round(mean(cpdf$form.Attitudes.old_people_get_world,na.rm=T),2)` when asked if old people understand the world youth are growing up in.  However, for both of those questions, youth score significantly higher than people ove 30.
...
Adults more than youth.  North more than Ex north.  Muslim more than Chrstian.  Fulfulde more than French, both _way_ more than other language.
...
French way more, men way more, North way more.  Christian more. Youth more.
