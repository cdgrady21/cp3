...
Though these questions for a reasonably strong index and "move together" (as the response to one question is more tolerant the likelihood of the others being tolerant increases strongly), the baseline values for these questions differ slightly by subgroup.   these questions measure distinct outcomes in themselves.
